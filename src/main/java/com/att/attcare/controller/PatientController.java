...
public class PatientController {
    ...
    public Optional<Patient> getPatientById(@PathVariable Long id)  throws NotFoundException{
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Patient> updatePatient(@PathVariable Long id, @RequestBody @Valid Patient updatedPatient) throws NotFoundException{
